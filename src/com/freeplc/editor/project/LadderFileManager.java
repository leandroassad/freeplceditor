...
public class LadderFileManager {
	ArrayList<LadderFile> inputLadderFileList = new ArrayList<LadderFile>();
	ArrayList<LadderFile> outputLadderFileList = new ArrayList<LadderFile>();
	ArrayList<LadderFile> memoryLadderFileList = new ArrayList<LadderFile>();
	ArrayList<LadderFile> numericLadderFileList = new ArrayList<LadderFile>();
	ArrayList<LadderFile> floatLadderFileList = new ArrayList<LadderFile>();
